...
switch choice
{
	case options.two_player:
	{
		...
		draw_text_color(xx,yy1,"TUTORIAL", c_black,c_black,c_black,c_black,1);
		draw_text_color(xx,yy2,"EXIT", c_black,c_black,c_black,c_black,1);
		break;	
	}
	case options.training:
	{
		draw_text_color(xx,yy,"TWO PLAYER", c_black,c_black,c_black,c_black,1);
		draw_text_color(xx,yy1,"TUTORIAL",c_red,c_red,c_red,c_red,1);
		draw_text_color(xx,yy2,"EXIT", c_black,c_black,c_black,c_black,1);
		break;	
	}
	case options.exit_game:
	{
		draw_text_color(xx,yy,"TWO PLAYER", c_black,c_black,c_black,c_black,1);
		draw_text_color(xx,yy1,"TUTORIAL",c_black,c_black,c_black,c_black,1);
		draw_text_color(xx,yy2,"EXIT",c_red,c_red,c_red,c_red,1);
		break;	
	}
